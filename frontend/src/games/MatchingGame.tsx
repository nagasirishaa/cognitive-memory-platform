...
function MatchingGame() {
  ...
  // Save completed game to backend
  useEffect(() => {
    if (!gameCompleted || resultSaved) return;
    ...
    async function saveResult() {
      try {
        const finalAccuracy =
          attempts === 0
            ? 0
            : Math.round((score / 10 / attempts) * 100);
    ...
    saveResult();
  }, [gameCompleted, resultSaved, attempts, score]);
